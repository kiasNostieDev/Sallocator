            ...
            <div className='adminLogin'>
                ...
                <div className='FormSide'>
                    ...
                    <FormControl style={{width: '400px'}} variant="outlined">
                        ...
                        <OutlinedInput onChange={(e)=>i2=e.target.value} type="password" labelWidth={100}/>
                    </FormControl>
                    <div style={{marginTop:"25px"}}></div>
                    <Button variant="contained" color="primary" style={{ backgroundColor: '#E6AF2E' }} onClick={() => {
                        firebase.auth().signInWithEmailAndPassword(i1, i2)
